...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println("Периметр квадрата равна:" + square.perimeter());

        Straight straight = new Straight(2, 3);
        System.out.println("Площадь прямоугольника равна:" + straight.square());
        System.out.println("Периметр прямоугольник равна:" + straight.perimeter());

        Triangle triangle = new Triangle(1, 2, 3);
        System.out.println("Площадь треугольника равна:" + triangle.square());
        System.out.println("Периметр треугольника равна:" + triangle.perimeter());
